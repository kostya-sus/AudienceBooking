    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ViewData["InvalidLoginAttempt"] = Localization.Localization.InvalidLoginAttempt_Message;
                    return View(model);
            }
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                bool userExists = await UserManager.FindByEmailAsync(model.Email) != null;
                userExists |= await UserManager.FindByNameAsync(model.UserName) != null;
                if (!userExists)
                {
                ...
                {
                    ViewData["UserExistsError"] = Localization.Localization.RegisterAction_UserAlreadyExists;
                }
            }
